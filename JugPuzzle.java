...
public class JugPuzzle extends Observable{
	...
	public JugPuzzle() {
		...
		this.moves = 0;
		this.setChanged();
		this.notifyObservers("Jugs 0, 1, 2 Created!" );
	}
	 ...
	 * This counts as a single move. Notify observers after each move. 
	 * 
	...
	public void move(int from, int to) {
		if(0<=from && from<jugs.length && 0<=to && to<jugs.length){
			...
			moves++;
			this.setChanged();
			this.notifyObservers("Moves: " + this.getMoves());
		}
	}

	/**
	 * Returns the array consisting of three jugs, (numbered 0,1 and 2)
	 * 
	 * @return jugs array
	 */
	public Jug[] getJugs(){
